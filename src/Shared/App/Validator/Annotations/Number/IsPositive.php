 ...
 * Class IsPositive
 *
 * This class is a custom attribute used to validate if a property of an object is a positive number.
 * Optionally, it can also validate if each item in an array is a positive number.
 *
 * @package Shared\App\Validator\Annotations\Number
 */
#[Attribute(Attribute::TARGET_PROPERTY)]
class IsPositive implements IValidateConstraint
{
    /**
     * IsPositive constructor.
     *
     * @param string|null $message Custom error message.
     * @param bool $each If true, each item in the array should also be a positive number.
     */
     ...
     *
     * Checks if value is a number and is greater than or equal to zero. If $each is true, it checks each item in the array.
     *
     * @param ReflectionProperty $property The property to validate.
     * @param object $object The object containing the property.
     * @return bool Returns true if the property is a positive number and, if $each is true, each item in the array is also a positive number.
     */
    ...
    public function defaultMessage(ReflectionProperty $property, object $object): string
    {
        ...
        $message = "Property {$property->getName()} must be a positive number";
