 ...
 * Class IsString
 *
 * This class is a custom attribute used to validate if a property of an object is a string.
 * Optionally, it can also validate if each item in an array is a string.
 *
...
class IsString implements IValidateConstraint
{
     ...
     * @param bool $each If true, each item in the array should also be a string.
     */
     ...
     * @return bool Returns true if the property is a string and, if $each is true, each item in the array is also a string.
     * @throws Exception
     */
