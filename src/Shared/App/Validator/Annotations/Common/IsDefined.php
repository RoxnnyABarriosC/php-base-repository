 ...
 * Class IsDefined
 *
 * This class is a custom attribute used to validate if a property of an object is defined (not null).
 * Optionally, it can also validate if each item in an array is defined.
 *
 * @package Shared\App\Validator\Annotations\Common
 */
#[Attribute(Attribute::TARGET_PROPERTY)]
class IsDefined implements IValidateConstraint
{
    /**
     * IsDefined constructor.
     *
     * @param string|null $message Custom error message.
     * @param bool $each If true, each item in the array should also be defined.
     */
     ...
     * @return bool Returns true if the property is defined and, if $each is true, each item in the array is also defined.
     */
    ...
    public function defaultMessage(ReflectionProperty $property, object $object): string
    {
        ...
        $message = "Property {$property->getName()} must defined.";
